...
hsh clone -p "package/dep/prefix" "git/package_dep/.git" \
...
[ -e "package/dep/prefix/file_dep" ] || test_fail "file_dep missing"
[ -e "package/dep/prefix/subdir_dep/subfile_dep" ] || test_fail "subdir_dep/subfile_dep missing"
